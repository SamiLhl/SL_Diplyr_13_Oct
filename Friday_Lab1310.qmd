...
```
`r table4` This table summarize the mean liveness and danceability of songs on a yearly basis. It gives a numerical representation to the graph that follows in the next question.
